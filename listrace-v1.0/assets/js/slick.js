...
(function(i){"use strict";
    var e=window.Slick||{};e=function(){function e(e,o){
    var s;
    var n = this;
            n.defaults = {
                accessibility: !0,
                ...
                nextArrow: '<div style="margin: auto"><button class="slick-next" aria-label="Next" type="button">Next</button></div>',
                autoplay: !0,
                autoplaySpeed: 400,
                centerMode: !1,
                centerPadding: "100px",
...
var s = i(this).attr("data-sizes") || r.$slider.attr("data-sizes");
...
var r = this;
        ...
        n <= r.slideCount && n++)), t = r.$slider.find(".slick-slide").slice(s, n), "anticipated" === r.options.lazyLoad) for(var l=s-1,d=n,a=r.$slider.find(".slick-slide"),c=0;c<r.options.slidesToScroll;c++)l<0&&(l=r.slideCount-1),t=t.add(a.eq(l)),t=t.add(a.eq(d)),l--,d++;
...
var e = this;
        ...
        {var i,t,o=this,s=arguments[0],n=Array.prototype.slice.call(arguments,1),r=o.length;for(i=0;i<r;i++)if("object"==typeof s||"undefined"==typeof s?o[i].slick=new e(o[i],s):t=o[i].slick[s].apply(o[i].slick,n),"undefined"!=typeof t)return t;return o}}});